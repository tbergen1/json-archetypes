module.exports.run = function(callback) {
	...
	test('****** Test Product Archetype Validator - Empty Object', function(t) {
		...
		JATs.validateProduct(instance, function(errors, product) {
			t.equal(errors.schema, 'Product Instance is empty', 'Error saying instance is empty');
			t.end();
		});
	});

	test('****** Test Product Archetype - Missing Title, Price, Seller', function(t) {
	...
	test('****** Test Product Archetype - Invalid Formats', function(t) {
